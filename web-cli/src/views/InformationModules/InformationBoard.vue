    ...
    <div>
        ...
        <div class="board" >
            <el-breadcrumb separator-class="el-icon-arrow-right" style="height: 30px;">
                ...
                <el-breadcrumb-item class="breadcrumb-item_center">重点领域信息公开</el-breadcrumb-item>
                <el-breadcrumb-item class="breadcrumb-item_center">{{itemTitle}}</el-breadcrumb-item>
