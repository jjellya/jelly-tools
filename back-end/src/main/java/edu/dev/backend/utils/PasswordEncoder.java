...
//		boolean passwordValid = encoderMd5.validPassword("1bd98ed329aebc7b2f89424b5a38926e", "test");
        boolean passwordValid = encoderMd5.matches("10f7a89302c5d04a7ae6ab368bc2c174", "123456");
        System.out.println("匹配结果:"+passwordValid);

        PasswordEncoder encoderSha = new PasswordEncoder(salt, "SHA");
        String pass2 = encoderSha.encode("123456");
        System.out.println("密文："+pass2);
//		boolean passwordValid2 = encoderSha.validPassword("1bd98ed329aebc7b2f89424b5a38926e", "test");
        boolean passwordValid2 = encoderSha.matches("613b1ded5101a55258976686188dd54d4c4bc4bf", "123456");
        System.out.println("匹配结果:"+passwordValid2);
    }
}
